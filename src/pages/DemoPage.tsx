    ...
    <div className="min-h-screen py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-24 space-y-8 max-w-3xl">
          <Badge variant="neutral" className="px-4 py-1.5 bg-white text-slate-500 border-slate-200">System Architecture</Badge>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-24">
          {[
            ...
            <Card key={i} className="p-10 border-slate-200 bg-white hover:shadow-lg transition-all">
        ...
        {/* The Methodology */}
        <Card className="p-12 md:p-20 border-slate-200 bg-white mb-24 relative overflow-hidden">
          <div className="absolute top-0 right-0 p-12 opacity-5">
            <Activity size={400} className="text-emerald-600" />
          </div>
          <div className="relative z-10 grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              <h2 className="text-4xl font-bold tracking-tight text-slate-900">The 4-Phase <br />Synthesis Protocol.</h2>
            ...
            <div className="bg-slate-50 rounded-3xl p-10 border border-slate-100 flex flex-col items-center justify-center text-center space-y-6">
              <Zap size={48} className="text-emerald-600" />
              <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Processing Engine Active</p>
        ...
        <div className="text-center py-20 border-t border-slate-200">
           <h2 className="text-4xl font-bold tracking-tight text-slate-900 mb-10">Define your protocol today.</h2>
